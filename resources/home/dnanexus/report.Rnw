...
print(generateSensitivityCountXTable(data, quote(muttype == "Del" & zyg %in% c("RA", "AA")), .(zyg, mutsize), caption = "Deletion sensitivity"), sanitize.text.function = function(x) x, include.rownames = FALSE, hline.after = c(-1, 0), tabular.environment = "longtable", caption.placement = "top")
@
