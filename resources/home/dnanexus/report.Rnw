...
temp.sample_table = data.frame(
    "Report Label" = sapply(data, function(x) texquote(x$label)),
...
<<sensitivity-snv-marginal-plots,fig.width=5,fig.height=5,out.width='2.5in',fig.show='hold'>>=
...
print(generateSensitivitySummaryXTable(data, quote(muttype == "Subst" & zyg %in% c("RA", "AA")), .(zyg), ci_method = CI_MODEL, ci_level = CI_LEVEL, add_total_var_count = TRUE, caption = "SNV sensitivity: summary"), sanitize.text.function = function(x) x, include.rownames = FALSE, hline.after = c(-1, 0), tabular.environment = "longtable", caption.placement = "top")
@

<<sensitivity-snv-marginal-persample-table,results='asis'>>=
print(generateSensitivityCountXTable(data, quote(muttype == "Subst" & zyg %in% c("RA", "AA")), .(zyg), caption = "SNV sensitivity: per sample"), sanitize.text.function = function(x) x, include.rownames = FALSE, hline.after = c(-1, 0), tabular.environment = "longtable", caption.placement = "top")
@



<<sensitivity-snv-bydepth-plots,fig.width=5,fig.height=5,out.width='2.5in',fig.show='hold'>>=
...
print(generateSensitivitySummaryXTable(data, quote(muttype == "Subst" & zyg %in% c("RA", "AA")), .(zyg, depth), ci_method = CI_MODEL, ci_level = CI_LEVEL, add_total_var_count = FALSE, caption = "SNV sensitivity by depth: summary"), sanitize.text.function = function(x) x, include.rownames = FALSE, hline.after = c(-1, 0), tabular.environment = "longtable", caption.placement = "top")
@

<<sensitivity-snv-bydepth-persample-table,results='asis'>>=
print(generateSensitivityCountXTable(data, quote(muttype == "Subst" & zyg %in% c("RA", "AA")), .(zyg, depth), caption = "SNV sensitivity by depth: per sample"), sanitize.text.function = function(x) x, include.rownames = FALSE, hline.after = c(-1, 0), tabular.environment = "longtable", caption.placement = "top")
@
...
<<sensitivity-ins-bysize-plots,fig.width=5,fig.height=5,out.width='2.5in',fig.show='hold'>>=
...
print(generateSensitivitySummaryXTable(data, quote(muttype == "Ins" & zyg %in% c("RA", "AA")), .(zyg, mutsize), ci_method = CI_MODEL, ci_level = CI_LEVEL, add_total_var_count = TRUE, caption = "Insertion sensitivity by size: summary"), sanitize.text.function = function(x) x, include.rownames = FALSE, hline.after = c(-1, 0), tabular.environment = "longtable", caption.placement = "top")
@

<<sensitivity-ins-bysize-persample-table,results='asis'>>=
print(generateSensitivityCountXTable(data, quote(muttype == "Ins" & zyg %in% c("RA", "AA")), .(zyg, mutsize), caption = "Insertion sensitivity by size: per sample"), sanitize.text.function = function(x) x, include.rownames = FALSE, hline.after = c(-1, 0), tabular.environment = "longtable", caption.placement = "top")
@
...
<<sensitivity-del-bysize-plots,fig.width=5,fig.height=5,out.width='2.5in',fig.show='hold'>>=
...
print(generateSensitivitySummaryXTable(data, quote(muttype == "Del" & zyg %in% c("RA", "AA")), .(zyg, mutsize), ci_method = CI_MODEL, ci_level = CI_LEVEL, add_total_var_count = TRUE, caption = "Deletion sensitivity by size: summary"), sanitize.text.function = function(x) x, include.rownames = FALSE, hline.after = c(-1, 0), tabular.environment = "longtable", caption.placement = "top")
@

<<sensitivity-del-bysize-persample-table,results='asis'>>=
print(generateSensitivityCountXTable(data, quote(muttype == "Del" & zyg %in% c("RA", "AA")), .(zyg, mutsize), caption = "Deletion sensitivity by size: per sample"), sanitize.text.function = function(x) x, include.rownames = FALSE, hline.after = c(-1, 0), tabular.environment = "longtable", caption.placement = "top")
@
...
<<falsepositive-plots,fig.width=7,fig.height=5,out.width='2.5in',fig.show='hold'>>=
...
# fpr.NFPi_melted = melt(fpr.NFPi, value.name = "count")

# ggplot(dropDepthUnknown(fpr.NFPi_melted), aes(x = depth, y = count, group = sample, colour = sample)) + 
#     geom_line() + geom_point(size = 2, shape = 21, fill = "white") + 
