...
<<sensitivity-snv-marginal-table,results='asis'>>=
print(generateSensitivityCountXTable(data, quote(muttype == "Subst" & zyg %in% c("RA", "AA")), .(zyg), caption = "SNV sensitivity"), sanitize.text.function = function(x) x, include.rownames = FALSE, hline.after = c(-1, 0), tabular.environment = "longtable", caption.placement = "top")
@
...
<<sensitivity-snv-bydepth-table,results='asis'>>=
print(generateSensitivityCountXTable(data, quote(muttype == "Subst" & zyg %in% c("RA", "AA")), .(zyg, depth), caption = "SNV sensitivity by depth"), sanitize.text.function = function(x) x, include.rownames = FALSE, hline.after = c(-1, 0), tabular.environment = "longtable", caption.placement = "top")
@
...
<<sensitivity-ins-bysize-table,results='asis'>>=
print(generateSensitivityCountXTable(data, quote(muttype == "Ins" & zyg %in% c("RA", "AA")), .(zyg, mutsize), caption = "Insertion sensitivity"), sanitize.text.function = function(x) x, include.rownames = FALSE, hline.after = c(-1, 0), tabular.environment = "longtable", caption.placement = "top")
@
...
<<sensitivity-del-bysize-table,results='asis'>>=
