...
Create a WGS performance report.
    ...
    RDSOUT    Path to the output summary RDS.
...
cp -f ${PARAM_SCRATCH}/report.pdf ${PARAM_OUTPUT_PDF_PATH}
cp -f ${PARAM_SCRATCH}/report.rds ${PARAM_OUTPUT_RDS_PATH}
